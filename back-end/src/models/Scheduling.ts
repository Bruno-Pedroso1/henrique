...
interface SchedulingCreationAttributes
  extends Optional<SchedulingAttributes, "id"> {}

class scheduling
  extends Model<SchedulingAttributes, SchedulingCreationAttributes>
  implements SchedulingAttributes
{
  public id!: number;
